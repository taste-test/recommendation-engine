...
SECRET_KEY = 'AIzaSyBGbQFaxU0SowJ41O5mmw7YHesh_aV3EMg'
...
PROJECT_ID = 'tastetest-201915'

# CloudSQL & SQLAlchemy configuration
# Replace the following values the respective values of your Cloud SQL
# instance.
CLOUDSQL_USER = 'tempUser'
CLOUDSQL_PASSWORD = 'tempPwd123!'
CLOUDSQL_DATABASE = 'bookshelf'
# Set this value to the Cloud SQL connection name, e.g.
#   "project:region:cloudsql-instance".
# You must also update the value in app.yaml.
CLOUDSQL_CONNECTION_NAME = 'tastetest-201915:us-east4:library'
...
LOCAL_SQLALCHEMY_DATABASE_URI = (
    'mysql+pymysql://{user}:{password}@35.188.233.13:3306/{database}').format(
...
CLOUD_STORAGE_BUCKET = 'tastetest'
